         ...
         <div className={styles.content}>
            ...
            <ul className={styles.aboutItems}>
                <li className={styles.aboutItem}>
                    <img className={styles.imgsr} src={getImageUrl("about/dataengineer.png")} alt="cursor Icon" />
                ...
                <li className={styles.aboutItem}>
                    <img className={styles.imgsr} src={getImageUrl("about/datascientist.png")} alt="Server Icon" />
                    <div className={styles.aboutItemtext}>
                ...
                <li className={styles.aboutItem}>
                    <img className={styles.imgsr} src={getImageUrl("about/uiIcon.png")} alt="ui Icon" />
                    <div className={styles.aboutItemtext}>
